...
![]( https://github.com/shmulik-willinger/path_planing/blob/master/readme_img/path_planing.jpg?raw=true)
...
Process results
---
The vehicle successfully drive a lap around the track and according to the speed limit. Max Acceleration and Jerk were not Exceeded. The car does not have collisions, and stays in its lane (except for the time between changing lanes).

The following video demonstrate a smoothly lane changing when passing another car in the road:

![]( https://github.com/shmulik-willinger/path_planing/blob/master/readme_img/change_lanes.gif?raw=true)
